...
/**
 * Bootstrapper is part of the real-time payment architecture and orchestration reference implementation.
 * <p>
...
public class Bootstrapper {
    ...
    public void demo() {
        ...
        System.out.println("Bootstrapper demo() invoked at " + Instant.now());
    }
}
