...
/**
 * AsyncTaskExecutor is part of the real-time payment architecture and orchestration reference implementation.
 * <p>
...
public class AsyncTaskExecutor {
    ...
    public void demo() {
        ...
        System.out.println("AsyncTaskExecutor demo() invoked at " + Instant.now());
    }
}
