...
/**
 * PaymentLifecycleManager is part of the real-time payment architecture and orchestration reference implementation.
 * <p>
...
public class PaymentLifecycleManager {
    ...
    public void demo() {
        ...
        System.out.println("PaymentLifecycleManager demo() invoked at " + Instant.now());
    }
}
