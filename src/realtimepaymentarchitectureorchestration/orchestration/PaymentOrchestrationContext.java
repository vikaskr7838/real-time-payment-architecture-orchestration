...
/**
 * PaymentOrchestrationContext is part of the real-time payment architecture and orchestration reference implementation.
 * <p>
...
public class PaymentOrchestrationContext {
     ...
     */
    public PaymentOrchestrationContext() {
    ...
    public void demo() {
        ...
        System.out.println("PaymentOrchestrationContext demo() invoked at " + Instant.now());
    }
}
