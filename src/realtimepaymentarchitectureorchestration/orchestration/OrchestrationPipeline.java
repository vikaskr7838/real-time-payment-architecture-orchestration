...
/**
 * OrchestrationPipeline is part of the real-time payment architecture and orchestration reference implementation.
 * <p>
...
public class OrchestrationPipeline {
    ...
    public void demo() {
        ...
        System.out.println("OrchestrationPipeline demo() invoked at " + Instant.now());
    }
}
