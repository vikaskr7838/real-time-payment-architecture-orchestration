...
/**
 * FallbackRouteStrategy is part of the real-time payment architecture and orchestration reference implementation.
 * <p>
...
public class FallbackRouteStrategy {
    ...
    public void demo() {
        ...
        System.out.println("FallbackRouteStrategy demo() invoked at " + Instant.now());
    }
}
