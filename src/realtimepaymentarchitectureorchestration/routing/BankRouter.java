...
/**
 * BankRouter is part of the real-time payment architecture and orchestration reference implementation.
 * <p>
...
public class BankRouter {
    ...
    public void demo() {
        ...
        System.out.println("BankRouter demo() invoked at " + Instant.now());
    }
}
