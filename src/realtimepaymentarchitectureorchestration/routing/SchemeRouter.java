...
/**
 * SchemeRouter is part of the real-time payment architecture and orchestration reference implementation.
 * <p>
...
public class SchemeRouter {
    ...
    public void demo() {
        ...
        System.out.println("SchemeRouter demo() invoked at " + Instant.now());
    }
}
