...
/**
 * CurrencyRouter is part of the real-time payment architecture and orchestration reference implementation.
 * <p>
...
public class CurrencyRouter {
    ...
    public void demo() {
        ...
        System.out.println("CurrencyRouter demo() invoked at " + Instant.now());
    }
}
