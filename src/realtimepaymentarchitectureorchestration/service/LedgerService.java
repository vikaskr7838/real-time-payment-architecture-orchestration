...
/**
 * LedgerService is part of the real-time payment architecture and orchestration reference implementation.
 * <p>
...
public class LedgerService {
    ...
    public void demo() {
        ...
        System.out.println("LedgerService demo() invoked at " + Instant.now());
    }
}
