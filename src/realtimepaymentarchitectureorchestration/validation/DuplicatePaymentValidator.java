...
/**
 * DuplicatePaymentValidator is part of the real-time payment architecture and orchestration reference implementation.
 * <p>
...
public class DuplicatePaymentValidator {
     ...
     */
    public DuplicatePaymentValidator() {
    ...
    public void demo() {
        ...
        System.out.println("DuplicatePaymentValidator demo() invoked at " + Instant.now());
    }
}
