...
/**
 * CutoffTimeValidator is part of the real-time payment architecture and orchestration reference implementation.
 * <p>
...
public class CutoffTimeValidator {
    ...
    public void demo() {
        ...
        System.out.println("CutoffTimeValidator demo() invoked at " + Instant.now());
    }
}
