...
/**
 * AccountStatusValidator is part of the real-time payment architecture and orchestration reference implementation.
 * <p>
...
public class AccountStatusValidator {
    ...
    public void demo() {
        ...
        System.out.println("AccountStatusValidator demo() invoked at " + Instant.now());
    }
}
