...
/**
 * ClearingSystemMemberIdentification is part of the real-time payment architecture and orchestration reference implementation.
 * <p>
...
public class ClearingSystemMemberIdentification {
    ...
    public void demo() {
        ...
        System.out.println("ClearingSystemMemberIdentification demo() invoked at " + Instant.now());
    }
}
