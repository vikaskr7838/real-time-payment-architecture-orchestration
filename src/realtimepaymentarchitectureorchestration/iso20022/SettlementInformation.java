...
/**
 * SettlementInformation is part of the real-time payment architecture and orchestration reference implementation.
 * <p>
...
public class SettlementInformation {
    ...
    public void demo() {
        ...
        System.out.println("SettlementInformation demo() invoked at " + Instant.now());
    }
}
