...
/**
 * PaymentTypeInformation is part of the real-time payment architecture and orchestration reference implementation.
 * <p>
...
public class PaymentTypeInformation {
    ...
    public void demo() {
        ...
        System.out.println("PaymentTypeInformation demo() invoked at " + Instant.now());
    }
}
