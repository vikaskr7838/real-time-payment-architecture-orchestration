...
/**
 * Iso20022MessageFactory is part of the real-time payment architecture and orchestration reference implementation.
 * <p>
...
public class Iso20022MessageFactory {
    ...
    public void demo() {
        ...
        System.out.println("Iso20022MessageFactory demo() invoked at " + Instant.now());
    }
}
