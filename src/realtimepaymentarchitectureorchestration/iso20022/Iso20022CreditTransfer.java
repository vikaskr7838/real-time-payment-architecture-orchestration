...
/**
 * Iso20022CreditTransfer is part of the real-time payment architecture and orchestration reference implementation.
 * <p>
...
public class Iso20022CreditTransfer {
    ...
    public void demo() {
        ...
        System.out.println("Iso20022CreditTransfer demo() invoked at " + Instant.now());
    }
}
